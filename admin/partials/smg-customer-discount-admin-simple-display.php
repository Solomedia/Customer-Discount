...
<div id='product_d_customer_panel' class='panel woocommerce_options_panel'>
    ...
    <div class="par-opciones customers">
        <h4 style="width: 90%;text-align: center;margin: 5px 0px;text-decoration: underline;font-size: 16px;">Doctor (customer)</h4>
        <div class="optiones" style="flex: auto;margin: 0 10px 10px;  max-width: 90%;" >
            <?php
            ...
            ?>
                ...
                <div>
                    <div>
                        <select name="customer_id" id="customer_id" class="wc-enhanced-select regular-text" style="width: 100%;">
                        <?php 
    ...
    <div class="par-opciones discount">
    ...
    <div class="par-opciones messages-save">
        ...
        <div class="optiones" style="flex: auto;margin: 0 10px 10px;max-width: 25%;display: flex;align-items: center;justify-content: flex-end;" >
                <input type="button" id="add_discount" class="button button-primary button-large" style="margin-right: 15px;" value="Add" />
        </div>
    </div>
    <!-- fin option groups -->
    </div>
        <a href="#0" class="button button-primary button-large js-cd-panel-trigger" data-panel="main" style="display: block;margin: 15px auto;width: 190px;text-align: center;font-size: 15px;">
            <div class="content-a">
                    ...
                    <div class="divTable">
                        <div class="divTableBody">
                            <div class="divTableHeader">
                                ...
                                <div class="header__item"><a id="quantity_discount" class="filter__link filter__link--number" href="#">Quantity Discount</a></div>
                        ...
                        foreach($smg_discounts_all_customers as $pd){
                            if(($pdkey = array_search($product->get_id(), $pd)) !== false){
                                $empty_table = false;
                       ...
                       //empty result
                       if(!$customer_in_products && (!is_array($customer_in_products) || empty($customer_in_products) ) &&  $empty_table ) { ?>
                        ...
                        if($customer_in_products && count($customer_in_products)) {                        
                            foreach ($customer_in_products as $key => $value) {
                                ...
                                foreach($smg_discount_prod_options as $pd){
                                    ...
                                    foreach($smg_discount_prod_options['discounts'] as $discount_k => $discount_v){
                                        ...
                                        ?><div class="divTableRow">
                                            ...
                                            <div class="divTableCell">
                                                <div class="button remove_discoun_customer" data-element-qty="<?php echo $quantity_discount?>" data-element-id="<?php echo $value; ?>" data-element-id="<?php echo $product->get_id(); ?>">
                        ...
                        }//finaliza el else si encuentra productos
                        ?>
                        </div>
                    </div>
                </div>
